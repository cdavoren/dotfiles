...
if exists('loaded_taglist')
  hi TagListTagName  cterm=none	ctermfg=16	ctermbg=28	gui=none	guifg=#008700	guibg=#000000
  hi TagListTagScope cterm=none	ctermfg=16	ctermbg=28	gui=none	guifg=#008700	guibg=#000000
  hi TagListTitle    cterm=none	ctermfg=199	ctermbg=16	gui=none	guifg=#ff00af	guibg=#000000
  hi TagListComment  cterm=none	ctermfg=16	ctermbg=28	gui=none	guifg=#008700	guibg=#000000
